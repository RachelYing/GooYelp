...
public class FoodSafety {
  ...
  public FoodSafety(int foodSafetyId, Restaurants restaurant, int inspectionScore,
  ...
  public FoodSafety(Restaurants restaurant, int inspectionScore, String inspectionResult,
                    Date inspectionDate) {
    this.restaurant = restaurant;
    this.inspectionScore = inspectionScore;
    this.inspectionResult = inspectionResult;
